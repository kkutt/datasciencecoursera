...
# prepare subplot1
plot(datetime, power_consumption$Global_active_power, xlab = "", ylab = "Global Active Power", type = "l")

# prepare subplot2
plot(datetime, power_consumption$Sub_metering_1, xlab = "", ylab = "Energy sub metering", type = "l", col = "black")
lines(datetime, power_consumption$Sub_metering_2, col = "red")
lines(datetime, power_consumption$Sub_metering_3, col = "blue")
legend(x = "topright", lwd = 1, col = c("black", "red", "blue"),
       legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), bty = "n")

# prepare subplot3
plot(datetime, power_consumption$Voltage, xlab = "datetime", ylab = "Voltage", type = "l")

# prepare subplot4
plot(datetime, power_consumption$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type = "l")
